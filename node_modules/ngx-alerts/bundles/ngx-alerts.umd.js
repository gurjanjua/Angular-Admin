(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('rxjs/Subject'), require('rxjs/Observable'), require('rxjs/add/observable/interval'), require('rxjs/add/operator/scan'), require('rxjs/add/operator/take'), require('rxjs/BehaviorSubject'), require('@angular/animations'), require('@angular/common')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', 'rxjs/Subject', 'rxjs/Observable', 'rxjs/add/observable/interval', 'rxjs/add/operator/scan', 'rxjs/add/operator/take', 'rxjs/BehaviorSubject', '@angular/animations', '@angular/common'], factory) :
	(factory((global['ngx-alerts'] = {}),global.ng.core,global.Rx,global.Rx,global.Rx.Observable,global.Rx.Observable.prototype,global.Rx.Observable.prototype,global.Rx,global.ng.animations,global.ng.common));
}(this, (function (exports,core,Subject,Observable,interval,scan,take,BehaviorSubject,animations,common) { 'use strict';
...
var AlertService = (function () {
    ...
    AlertService.prototype.addAlert = function (alert) {
        ...
        Observable.Observable.interval(this.config.timeout).take(1).subscribe(function () {
